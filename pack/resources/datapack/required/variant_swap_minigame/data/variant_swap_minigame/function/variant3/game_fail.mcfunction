...
title @a[tag=variant3_player,limit=1] title {"text":"Game Over!", "color":"red"}
title @a[tag=variant3_player,limit=1] subtitle {"text":"Better luck next time!", "color":"dark_red"}
playsound minecraft:entity.player.death master @a[tag=variant3_player,limit=1] ~ ~ ~ 1 1
