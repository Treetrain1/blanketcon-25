...
execute if score minigame vs_round matches 6 run function variant_swap_minigame:variant3/game_success
execute if score minigame vs_round matches ..5 run schedule function variant_swap_minigame:variant3/round_game 60t
